export const msalConfig = {
  auth: {
    ...
    redirectUri: 'https://b2c.apanowi.cz', // You must register this URI on Azure Portal/App Registration. Defaults to window.location.origin
    postLogoutRedirectUri: 'https://b2c.apanowi.cz', // Indicates the page to navigate after logout.
  },
  cache: {
